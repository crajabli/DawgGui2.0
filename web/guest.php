...
<html lang="en">
  ...
  <div class="container">
    ...
    <?php
      ...
      $query = "SELECT users.user_id, users.username, image.src, post.caption, post.post_id, post.reaction FROM users INNER JOIN image INNER JOIN post WHERE post.user_id = users.user_id AND post.image_id = image.image_id";
